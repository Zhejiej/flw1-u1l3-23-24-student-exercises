...
creatureDescription = "Is magical"
...
let vistorAge;
vistorAge = Math.floor(Math.random () * 60) + 1;
...
let zooSummary = creatureName + " " + creatureDescription + isFriendly + "\n" + vistorAge + " " + canVisit
...
for(let i = 0; i<3; i++){
  let Creature = "Mystery" + i;
  let desc = "is a mystery"
  let friendly = "false";
  let vAge =  Math.floor(Math.random () * 60) + 1;
  let visit = vAge > 15;
}